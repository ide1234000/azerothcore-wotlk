...
static Yells Conversation[]=
{
    ...
    {14265, "对，对... 我已经知道土灵是由石头创造出来，用以改造地下世界的。但变异是怎么发生的？我听说过什么，母体扰动？", NPC_BRANN, 34800
    {13771, "正在检索...在其发展周期的初始阶段，艾泽拉斯世界遭受到了寄生性噬主共体生物的感染。", NPC_ABEDNEUM, 360000},
    {14266, "寄生性噬主...什么来着？讲通用语会死吗？", NPC_BRANN, 373500},
    {13772, "名称：上古之神。上古之神感染了包括土灵在内的无防备的系统，意图将所有事物向他们自身同化。这种扰动母体结构的行为与现象被定义为血肉
    {14267, "少跟我说他们给土灵施加什么血肉的诅咒！...然后怎么样？", NPC_BRANN, 399500},
    {13757, "正在检索... 造物主曾经亲自回来清除噬主共体生物所造成的感染。根据当时的评估，上古之神滋生所造成的危害非常严重，强行分离被感染部分
    {14268, "如果他们真的杀光上古之神，那艾泽拉斯也就毁灭了...", NPC_BRANN, 424000},
    {13758, "正确。造物主决定综合寄生体的威胁并将其封锁在宿主内部。之后包括一直融入在内的各系统授命开始创造新的土灵，植入了新的安全机制并任命
    {14269, "什么守护者？", NPC_BRANN, 449000},
    {13759, "名称：Aesir 和 Vanir。如果用通用语命名则是风暴巨人与原始巨人。 最高领袖为：哨兵洛肯。守护巨龙授命监管艾泽拉斯世界的进化过程。"
    ...
    {13763, "不详。数据显示全面战争是由首席管理官洛肯发起的。他在此之后中和了所有残余的Aesir和Vanir，结束了冲突。接着，他停止了包括土灵，巨
    {14272, "唉...这个洛肯听起来真是阴险狡诈。还好不用再理会他了。那么，如果我的理解没有错，最初的原始土灵是否因为某种原因从休眠舱里苏醒了过
