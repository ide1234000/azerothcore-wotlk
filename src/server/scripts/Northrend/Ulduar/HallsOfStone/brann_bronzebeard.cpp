...
#define GOSSIP_ITEM_1       "布莱恩，这将是我们的荣幸！"
#define GOSSIP_ITEM_2       "让我们开始吧，布莱恩，历史课已经上够了！"
#define GOSSIP_ITEM_3       "我们现在没有时间，我们必须坚持下去。"
#define GOSSIP_ITEM_4       "我们和你一起，布莱恩！ 打开它！"
#define TEXT_ID_START       13100
#define YELL_AGGRO          "你很快就要死了！"
...
static Yells Conversation[]=
{
    ...
    {14247, "休息一会然后和我一起来启动这个东西。 一切...马上就要真相大白啦。 好啦，我们开始吧！", NPC_BRANN, 5000},
    {14248, "你们帮我看着点外面！ 我这样的强者只要捶两下就能搞定这破烂儿...", NPC_BRANN, 17000},
    {13765, "警告：生命体形态模式无法辨识。 存档处理程式中断。 持续干涉程序将导致安全对策启动。", NPC_ABEDNEUM, 20500},
    {14249, "哦，见鬼！好像有点儿不太妙。 看来我们遇到一点儿小麻烦......", NPC_BRANN, 32000},
    {13756, "安全系统发现不明入侵。 历史文档的分析工作优先级转为低，对策程序立即启动！", NPC_KADDRAK, 37000},
    {14250, "嘿，破机器怎么样，你想跟我来硬的？ 太可惜了，这是属于我的游戏！", NPC_BRANN, 49000},
    {14251, "再给我几分钟，马上就能...啊哦...", NPC_BRANN, 100000},
    {13761, "已超出威胁指数标准。 天界档案中断。 提高安全级别。", NPC_MARNAK, 105000},
    {14252, "提高？这算是好消息吗？", NPC_BRANN, 116000},
    {14253, "哈，终于找到问题出在哪儿啦。 我马上就能搞定了......", NPC_BRANN, 195000},
    {13767, "威胁指数过高。 虚空分析程序关闭。 启动清理协议。", NPC_ABEDNEUM, 205000},
    {14254, "等等！你想清理谁啊？有我在，没门儿！", NPC_BRANN, 215000},
    {14255, "哈！看来还是我这把老骨头厉害啊！然后再看看这里...", NPC_BRANN, 295000},
    {13768, "警告：安全系统自动修复装置已被关闭。消除全部存储器内容并... ", NPC_ABEDNEUM, 303000},
    //The fight is completed at this point.
    {14256, "消除？ 不，不，不，不，不，不...我刚才...啊哈，应该是这样...", NPC_BRANN, 310000},
    {13769, "系统已上线。生命形态模式已确认。您好，布莱恩·铜须，是否需要问询？", NPC_ABEDNEUM, 321000},
    {14263, "问询？ 要不你以为我来这儿干嘛？ 喝下午茶吗？少废话！", NPC_BRANN, 329000},
    {14264, "告诉我，人是怎样演化来的，从最初开始！", NPC_BRANN, 336000},
    {13770, "正在检索史前数据... 文档定位完毕。 创世之初，土灵的使命是...", NPC_ABEDNEUM, 342000},
    {14265, "对，对... 我已经知道土灵是由石头创造出来，用以改造地下世界的。但变异是怎么发生的？我听说过什么，母体扰动？", NPC_BRANN, 348000},
    {13771, "正在检索...在其发展周期的初始阶段，艾泽拉斯世界遭受到了寄生性噬主共体生物的感染。", NPC_ABEDNEUM, 360000},
    {14266, "寄生性噬主...什么来着？讲通用语会死吗？", NPC_BRANN, 373500},
    {13772, "名称：上古之神。上古之神感染了包括土灵在内的无防备的系统，意图将所有事物向他们自身同化。这种扰动母体结构的行为与现象被定义为血肉诅咒，扰动的效果...", NPC_ABEDNEUM, 380000},
    {14267, "少跟我说他们给土灵施加什么血肉的诅咒！...然后怎么样？", NPC_BRANN, 399500},
    ...
    {13758, "正确。造物主决定综合寄生体的威胁并将其封锁在宿主内部。之后包括一直融入在内的各系统授命开始创造新的土灵，植入了新的安全机制并任命了守护者", NPC_KADDRAK, 429000},
    {14269, "什么守护者？", NPC_BRANN, 449000},
    {13759, "名称：Aesir 和 Vanir。如果用通用语命名则是风暴巨人与原始巨人。 最高领袖为：哨兵洛肯。守护巨龙授命监管艾泽拉斯世界的进化过程。", NPC_KADDRAK, 452000},
    {14270, "Aesir 与 Vanir... 好吧，这么说一只熔炉又从头开始创造了新的土灵... 老的怎么样了？", NPC_BRANN, 471000},
    {13762, "定有后台信息与你的问询关联。在Aesir和Vanir的全面战争之后...", NPC_MARNAK, 482000},
    {14271, "等等...等等！你是说Aesir和Vanir之间爆发了战争？为什么？", NPC_BRANN, 489000},
    {13763, "不详。数据显示全面战争是由首席管理官洛肯发起的。他在此之后中和了所有残余的Aesir和Vanir，结束了冲突。接着，他停止了包括土灵，巨人和维库仁在内的数个远种生物的演化进程， 并将他们全部封存在指定的封存舱内。", NPC_MARNAK, 494000},
    {14272, "唉...这个洛肯听起来真是阴险狡诈。还好不用再理会他了。那么，如果我的理解没有错，最初的原始土灵是否因为某种原因从休眠舱里苏醒了过来还受了这个什么母体扰动的影响，最终演化成现在的矮人。至少是现代矮人的祖先。嗯？", NPC_BRANN, 519000},
    {13764, "本质上的确如此。", NPC_MARNAK, 543000},
    {14273, "唉，现在我得花上很长时间来好好消化这些知识... 我要在这里再呆一会儿。谢谢你们！", NPC_BRANN, 549000},
    {13773, "收到，布莱恩·铜须。进程中止。", NPC_ABEDNEUM, 559000},
    {0, "我想是时候看看门后面靠近入口的地方了。我要偷偷溜过去，安静又好。在门口等我，我会让我们进去。", NPC_BRANN, 574000},
};
        ...
        void DoAction(int32 action) override
        {
            switch (action)
            {
                ...
                case ACTION_START_SJONNIR_FIGHT:
                    me->setFaction(35);
                    me->MonsterYell("嘿，别担心！布莱恩回来了。把这些该死的金属怪物给我挡住。我也该好好跟这台可爱的大机器谈谈，然后帮帮你们！", LANG_UNIVERSAL, 0);
                    me->PlayDirectSound(14274);
                    SetEscortPaused(false);
                    break;
                case ACTION_SJONNIR_DEAD:
                    me->MonsterYell("洛肯？这下碰到大麻烦了...虽然铁人已经被全部摆平了，但我敢打赌，不知道什么鬼地方还有一台机器正不停向外吐着铁维库人！", LANG_UNIVERSAL, 0);
        ...
        void UpdateEscortAI(uint32 diff) override
        {
            ...
            switch (events.GetEvent())
            {
                ...
                case EVENT_END:
                {
                    ...
                    me->SetUInt32Value(UNIT_NPC_FLAGS, UNIT_NPC_FLAG_GOSSIP | UNIT_NPC_FLAG_QUESTGIVER);
                    me->MonsterYell("我会用熔炉来制造一些土灵...让他们保卫这里。但我们最大的挑战仍然存在：找到并阻止洛肯！", LANG_UNIVERSAL, 0);
