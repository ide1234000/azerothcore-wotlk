    ...
    struct boss_thorimAI : public ScriptedAI
    {
        ...
        void DamageTaken(Unit* who, uint32& damage, DamageEffectType, SpellSchoolMask)
        {
            if (who && _isHitAllowed && who->GetPositionZ() > 430 && who->GetTypeId() == TYPEID_PLAYER)
            {
                ...
                me->MonsterYell("不礼貌的小崽子！你敢在我的王座上挑战我！我要亲自碾碎你！", LANG_UNIVERSAL, 0);
        ...
        void UpdateAI(uint32 diff)
        {
            ...
            switch (events.GetEvent())
            {
                case EVENT_THORIM_AGGRO:
                    me->MonsterYell("闯入者！你们这些敢于干涉我的凡人会付出代价…等等-你…", LANG_UNIVERSAL, 0);
                ...
                case EVENT_THORIM_LIGHTNING_ORB:
                {
                    ...
                    // No players found
                    me->MonsterYell("失败！弱者！", LANG_UNIVERSAL, 0);
                ...
                case EVENT_THORIM_BERSERK:
                    ...
                    events.PopEvent();
                    me->MonsterYell("我忍无可忍了！", LANG_UNIVERSAL, 0);
