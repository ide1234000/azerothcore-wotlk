...
const char* GOSSIP_ITEM_TOM_HEGGER = "你是怎么知道诅咒教派的？";
const char* GOSSIP_ITEM_GUARD_MITCHELLS = "你为诅咒教派工作了多久？";
const char* GOSSIP_ITEM_SALTY_JOHN_THORPE = "我有理由相信你参与了宗教活动";
